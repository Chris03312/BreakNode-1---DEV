...
const UsersModel = {
    ...
    InsertData: async (UserId, Name, Campaign, Password, FffBreak, FftBreak, ToneHour, FoneHour, SffBreak, SftBreak) => {
        ...
        return await connection.run('breaksystem', sql, [UserId, Name, Campaign, Password, FffBreak, FftBreak, ToneHour, FoneHour, SffBreak, SftBreak, 'Enable']);
    },
    EditData: async (id) => {
    ...
    UpdateUser: async (UserId, Name, Campaign, Password) => {
        ...
        return await connection.run('breaksystem', sql, [Name, Campaign, Password, UserId]);
    },
    UpdateSchedule: async (UserId, FffBreak, FftBreak, FoneHour, ToneHour, SffBreak, SftBreak) => {
        ...
        return await connection.run('breaksystem', sql, [FffBreak, FftBreak, FoneHour, ToneHour, SffBreak, SftBreak, UserId]);
    },
    DeleteUser: async (UserId) => {
        const sql = 'DELETE FROM users WHERE id = ?';
        return await connection.run('breaksystem', sql, [UserId]);
    },
